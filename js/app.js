const common = {
	...
	main: () => {
		...
		menuTrigger.forEach(trigger => trigger.addEventListener('click', (event) => {
		...
		openPopupTrigger.forEach(trigger => trigger.addEventListener('click', (event) => {
			event.preventDefault();
			document.querySelector('body').classList.add('popup-opened');
		}));

		closePopupTrigger.forEach(trigger => trigger.addEventListener('click', (event) => {
			event.preventDefault();
